...
function submit(){
    ...
    if (first_name_input == "" || gender == "" || full_dob=="") {
    ...
    else if(first_name_input.indexOf(' ') !== -1){
        console.log("Space");
        alert("Please fill only your first name. The middle name / last name is to be added in the last-name input box.")
    }
    else {
        console.log("Loading") 
        ...
        if(psychic_number == "1" && destiny_number == "8"){
            document.getElementById("pd_combination_description").textContent = "You have an anti combination of Psychic number and Destiny number. If supportive numbers are present in your date of birth, then it is good, otherwise, you would lead a life full of ups and downs. You need to work very hard to achieve success. Most of the time, you would struggle in your life. You might have health issues or relationship issues as well."        
        ...
        if(psychic_number == "5" && destiny_number == "1"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You look smart and you are young at heart. You have good communication skills. You are popular in your friend-circle. It can be said you are a good entertainer. You always want be a leader. You love to lead a royal life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "5" && destiny_number == "2"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You look smart and you are young at heart. You have good communication skills. Your imagination powers and intuition powers are good. You are foody, you may be chubby and lazy too."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 4, 8, 9"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "5" && destiny_number == "3"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You have good knowledge and creative skills. You are sensitive and very emotional. Sometimes, you are lazy. You have good communication skills and you are intelligent."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5"
            document.getElementById("bad_no").textContent = "Bad No. : 6"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black. White"
        ...
        if(psychic_number == "5" && destiny_number == "4"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You are very logical and practical. You are a risk taker. You are intelligent. If you work hard, you will achieve success. But if you are lazy, you would be far behind success."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 2, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "5" && destiny_number == "5"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You never like to take any pressure and don't like the interference of others in your life. You are always young at heart. You are helpful in nature. Sometimes, you may lazy."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
        ...
        if(psychic_number == "5" && destiny_number == "6"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You look smart and you are young at heart. You have good communication skills. You are romantic in nature. You are very supportive. When needed, you can manipulative things easily."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
        ...
        if(psychic_number == "5" && destiny_number == "7"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You have good communication skills. You have good knowledge and creative skills. Your imagination powers and intuition powers are good. You are emotional. Therefore, sometimes there are chances to face disappointment and depression."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : None"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "5" && destiny_number == "8"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You have good communication skills. If supporting numbers in your chart are present, then it's good. Otherwise, you would face ups and downs in your life. You need to work very hard to achieve success. You are intelligent. But if you don't work hard, you may face a lot of struggle in your life. You would always face delay in your life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 1, 2, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Red, Black"
        ...
        if(psychic_number == "5" && destiny_number == "9"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are self-responsible and self-accountable in life. You are physically strong. You are compassionate in nature. Sometimes, you are short-tempered. You are driven by your mood only."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
        ...
        if(psychic_number == "6" && destiny_number == "1"){
            document.getElementById("pd_combination_description").textContent = "You have a very good combination of Psychic number and Destiny number. You have a very powerful aura. You are very sweet spoken and romantic. You are manipulative in nature to some but supportive to others. You are always surrounded by name, fame and money. You can lie easily and you are tempted towards luxury. You love to be  the only leader in your life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 3, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black, Yellow"
        ...
        if(psychic_number == "6" && destiny_number == "2"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. Your mood changes frequently. You are sweet-spoken and romantic. You always seek attraction in life. You are family-oriented and foody."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
        ...
        if(psychic_number == "6" && destiny_number == "3"){
            document.getElementById("pd_combination_description").textContent = "You have an anti combination of Psychic number and Destiny number. You would face ups and downs in your life. You would face struggle in your life. You are intelligent. You have good knowledge and you may be in good position in life and have luxury. But you might have health issues or relationship issues in your life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5"
            document.getElementById("bad_no").textContent = "Bad No. : 3, 6"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black, White, Yellow"
        ...
        if(psychic_number == "6" && destiny_number == "4"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are romantic. You always seek attraction in life. You are manipulative to some in nature but supportive to others. You are always surrounded by name, fame and money. You can lie easily and you are tempted towards luxury all the time. You are very logical and practical. You get angry easily."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 2, 3, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black, Yellow"
        ...
        if(psychic_number == "6" && destiny_number == "5"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You look smart and you are young at heart. You have good communication skills. You are romantic in nature. You are very supportive to others. When needed, you can manipulative things easily. You are self-responsible and self-accountable in life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 3, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black, Yellow"
        ...
        if(psychic_number == "6" && destiny_number == "6"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You look smart and you are young at heart. You are romantic in nature. You are very supportive to others. You are always obsessed with your kids and loved ones .When needed, you can manipulative things easily. You would have good luxury in life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 3, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black, Yellow"
        ...
        if(psychic_number == "6" && destiny_number == "7"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You look smart and you are young at heart. You are romantic in nature. You are very supportive to others. You have good knowledge and creative skills. Your imagination powers and intuition powers are good. You are emotional. Therefore, sometimes there are chances for you to face disappointment and depression."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 3, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black, Yellow"
        ...
        if(psychic_number == "6" && destiny_number == "8"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You look smart and you are young at heart. You are romantic in nature. You are very supportive to others. If supporting numbers are present in your chart, then it's good. Otherwise, you would face ups and downs in your life. You need to work very hard to achieve success. You are intelligent. If you don't work hard, you may face a lot of struggle in your life. You would face delay in your life."
        ...
        if(psychic_number == "6" && destiny_number == "9"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You look smart and you are young at heart. You are romantic in nature. You are very supportive to others. You are physically strong. You are compassionate in nature. Sometimes, you are short-tempered. You are only driven by your mood."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 3"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black, Yellow"
        ...
        if(psychic_number == "7" && destiny_number == "1"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. If supporting numbers are present in your chart, then you would reach great heights in your life. You are creative. You have wisdom. You know the art of solving any issue. Your imagination powers and intuition powers are very good. You are interested in spirituality. You are soft-spoken. But you will face some kind of disappointment in life which can lead you towards depression. You love to be a leader and you have a little bit of ego too."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "7" && destiny_number == "2"){
            document.getElementById("pd_combination_description").textContent = "You have a weak combination of Psychic number and Destiny number. You are very sensitive and emotional. Your mind swings a lot. It means you have a flickering mind set and you are very moody. Your imagination powers and intuition powers are good. Sometimes, there are chances for you to get depressed very easily. You would always need someone's support in life to achieve success."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 4, 8, 9"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "8" && destiny_number == "1"){
            document.getElementById("pd_combination_description").textContent = "You have an anti-combination of Psychic number and Destiny number. If supporting numbers are present in your chart, then it's good. Otherwise, you would face ups and downs in your life. You need to work very hard to achieve success. Most of the time, you would face struggle in your life. You might have health issues or relationship issues too."
            document.getElementById("lucky_no").textContent = "Lucky No. : 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 1, 2, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Red, Black"
        ...
        if(psychic_number == "8" && destiny_number == "2"){
            document.getElementById("pd_combination_description").textContent = "You have an anti-combination of Psychic number and Destiny number. You would face ups and downs in your life. You need to work very hard to achieve success. Most of the time, you would face struggle in your life. You might have health issues or relationship issues too. You may face some struggle in your career too."
            document.getElementById("lucky_no").textContent = "Lucky No. : 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 1, 2, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Red, Black"
        ...
        if(psychic_number == "8" && destiny_number == "3"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You need to work very hard to get success. You are intelligent. If you don't work hard, you may face a lot of struggle in your life. You have good knowledge and creative skills. If supporting numbers are present in your chart, then it's good. Otherwise, you would face ups and downs in your life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 3, 5"
            document.getElementById("bad_no").textContent = "Bad No. : 1, 2, 4, 6, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Green, White"
        ...
        if(psychic_number == "8" && destiny_number == "4"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are very logical and practical in life. By nature, you are very rebellious and argumentative. You get angry easily. You would face some struggle in your life. Sometimes, you might face legal issue or controversies in life too. You can only achieve success in life with the help of hard work."
            document.getElementById("lucky_no").textContent = "Lucky No. : 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 1, 2, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Red, Black"
        ...
        if(psychic_number == "8" && destiny_number == "5"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. If supporting numbers are present in your chart, then it's good. Otherwise, you would face ups and downs in your life. You need to work very hard to achieve success. You are intelligent. If you don't work hard, you may face a lot of struggle in life. You would face delay in your life. You are self-responsible and self-accountable. You have good communication skills as well."
            document.getElementById("lucky_no").textContent = "Lucky No. : 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 1, 2, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Red, Black"
        ...
        if(psychic_number == "8" && destiny_number == "6"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. If supporting numbers are present in your chart, then it's good. Otherwise, you would face ups and downs in your life. You need to work very hard to achieve success. You look smart and you are young at heart. You are romantic in nature. You are intelligent. If you don't work hard, you may face a lot of struggle in life. You would face delay in your life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 5, 6"
        ...
        if(psychic_number == "9" && destiny_number == "2"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You would face ups and down in your life. You are moody in nature. Most of the time, you would face struggle in your life. You might have health issues or relationship issues. You are very intelligent and you have good memory power. If supporting numbers are present in your chart, then it's good. Otherwise, you would face ups and downs in your life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 2, 4, 8"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "9" && destiny_number == "5"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are physically strong. You are compassionate in nature. Sometimes, you are short-tempered. You are driven only by your mood. Your communication skills are good. You are self-responsible and self-accountable in life."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
            document.getElementById("bad_no").textContent = "Bad No. : 2, 4"
            document.getElementById("lucky_colour").textContent = "Lucky Colours : Red, Yellow, Green, White"
            document.getElementById("bad_colour").textContent = "Bad Colours : Black"
        ...
        if(psychic_number == "9" && destiny_number == "6"){
            document.getElementById("pd_combination_description").textContent = "You have an average combination of Psychic number and Destiny number. You are very supportive to others. You are physically strong. You are compassionate in nature. Sometimes, you are short-tempered. You are driven only by your mood. You look smart and you are young at heart. You are romantic in nature."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 5, 6"
